...
for file in os.listdir("./"):
    if file.endswith(".z64"):
        ...
        print("Mario Party 3 ROM not found, screw you, go get a life and steal it from your local game store.")
        exit()

output_file = 'bin/Chaos Party 3 (USA).z64'
gameshark_file = 'src/codes.txt'
...
gameshark_hex = lib.gameshark_to_hex(gameshark_codes)
boot_gameshark_hex = lib.gameshark_to_hex(gameshark_codes, boot=True)
